import numpy as np
import pandas as pd
import previous_ai.util
from previous_ai.othello import Othello
from previous_ai.constants import COLUMN_NAMES
...
class StartTables:
    ...
    def _init_start_tables(self):
        """
        read start tables from csv file 'previous_ai/start_moves.csv'
        and store them in _start_tables
        """
        csv = pd.read_csv('previous_ai/start_moves.csv')
    ...
    def calculate_missing_start_moves(self):
        ...
        # store new start table in file 'previous_ai/start_moves.csv'
        with open('previous_ai/start_moves.csv', 'w') as f:
